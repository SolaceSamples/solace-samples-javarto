...
* Search [GitHub](https://github.com/SolaceSamples/solace-samples-javarto/pulls) for an open or closed Pull Request
...
Fork the project [on GitHub](https://github.com/SolaceSamples/solace-samples-javarto) and clone your fork
locally.

```sh
git clone https://github.com/<my-github-repo>/solace-samples-javarto
```
...
```sh
$ git remote add upstream https://github.com/SolaceSamples/solace-samples-javarto
```
...
In GitHub, send a pull request to `solace-samples-javarto:master`.
